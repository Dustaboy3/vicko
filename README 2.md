...
- [x] Email address and sign up
  - [x] Functioning enter email address and sign up
  - [x] check if it's an email 
  - [x] success state
- [x] Index and footer content
  - [x] header
  - [x] features
  - [x] footer - fix links
- [x] Features pages
...
- [x] Financing quiz
  - [x] design
  - [x] Update quiz - Would you continuously share business data to get a better rate and/or shorter approval time? 
  - [x] Backend
- [x] Session as user id tacking
- [x] Fix header burger menu on close - mobile
- [x] remove powered by
- [ ] Add translations
- [ ] Analytics
  - [ ] device tracking: 
  ...
  - [ ] track session end
- [ ] GDPR
- [ ] Make first picture better in industries
